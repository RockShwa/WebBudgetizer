...
1. Manage Income page that:
    - Displays all income transactions with donation amount & checkbox
    - Displays checking and savings account with subcategories
    - Allows me to group income transactions and automatically funnels the appropriate percentages of income to each category when a new income transaction is categorized
    - Allows me to change the percentage funneled
    - Savings and checking accounts are automatically updated through specific transactions
    - The user can set a "starting" checking/savings account balance if they want to disregard previous transactions
