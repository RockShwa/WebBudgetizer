...
<div class="flex flex-col">
    <div class="flex flex-row items-center">
        ...
        <button class="w-20 shadow-sm rounded bg-blue-500 hover:bg-blue-600 text-white py-1 ml-7">Back</button>
    </div>

    <div class="flex flex-row items-center">
        <label for="category" class="rounded-l bg-blue-500 h-7 ml-2">Category</label>
        <select id="category" class="rounded-r bg-blue-500 h-7 mr-2"></select>
